...
<body class="bg-[url(./assets/gapura.jpg)] bg-no-repeat bg-cover bg-center min-h-screen w-full flex justify-center items-center flex-col">
  ...
  <div class="w-[1000px] mt-10">
    ...
    if ($num > 0) {
      ...
      while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        echo "<div class='w-[100px]'>" . ($title !== null ? $title : '') . "</div>";
  ...
  <form class="max-w-md mt-10 bg-white" action="add_task.php" method="post">
    ...
    <div class="mb-5">
      ...
      <input type="textarea" name="description" id="description" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 h-[100px] dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Playing with friends and with 'No Radiant No Sleep' Mentality" required />
    </div>
